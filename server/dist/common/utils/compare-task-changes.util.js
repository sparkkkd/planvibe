...
exports.compareTaskChanges = compareTaskChanges;
function compareTaskChanges(oldTask, newValues) {
    const changes = [];
    ...
    if (newValues.assigneeId && newValues.assigneeId !== oldTask.assigneeId) {
        changes.push(`Исполнитель: "${oldTask.assigneeId}" → "${newValues.assigneeId}"`);
    }
    return changes;
}
//# sourceMappingURL=compare-task-changes.util.js.map